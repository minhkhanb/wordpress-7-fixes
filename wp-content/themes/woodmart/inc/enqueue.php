...
if ( ! function_exists( 'woodmart_enqueue_base_styles' ) ) {
	function woodmart_enqueue_base_styles() {
		...
		if ( class_exists( 'WeDevs_Dokan' ) && ( ! dokan_is_store_page() && ! dokan_is_seller_dashboard() && ! dokan_is_store_review_page() && ! is_account_page() && ! is_product() && ! dokan_is_store_listing() ) ) {
