!function (a) {
    woodmartThemeModule.$document.on("wdReplaceMainGallery", function () {
        ...
        function b() {
            f.trigger("destroy.owl.carousel"), f.addClass("owl-carousel").owlCarousel(woodmartThemeModule.mainCarouselArg), woodmartThemeModule.$document.trigger("wood-images-loaded")
        }

        function c() {
            var b = "";
            f.find(".woocommerce-product-gallery__image").each(function () {
                var c = a(this), d = c.data("thumb"), e = c.find("a img").attr("alt"),
        ...
        function e() {
            g.addClass("owl-carousel").owlCarousel({
                ...
                responsive: {
                    1025: {items: woodmart_settings.product_gallery.thumbs_slider.items.desktop},
                    769: {items: woodmart_settings.product_gallery.thumbs_slider.items.tablet_landscape},
                    577: {items: woodmart_settings.product_gallery.thumbs_slider.items.tablet},
                    0: {items: woodmart_settings.product_gallery.thumbs_slider.items.mobile}
                },
                margin: 12,
                dots: !1,
                nav: !0,
        ...
        var f = a(".woocommerce-product-gallery__wrapper:not(.quick-view-gallery)"), g = a(".images .thumbnails"),
